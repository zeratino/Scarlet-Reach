...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_WOODWALKER = span_notice("I can climb trees quicker, and gain climbing experience twice as quickly. I can step on thorns and branches safely in the woods.")
))
