...
#define COMSIG_NEW_ICHOR_FANG_SPAWNED "ichor_fang_spawned" // from /obj/item/rogueweapon/sword/long/judgement/vlord/Initialize() (spawned sword) to prevent IF dupe
