...
/datum/statpack/agile/thug
	name = "Thuggish"
	desc = "Your robust physique and enduring spirit oft been your most valuable friends in such trying times."
	stat_array = list(STAT_STRENGTH = 2, STAT_PERCEPTION = -2, STAT_ENDURANCE = 1, STAT_SPEED = -1)
