...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_CIVILIZEDBARBARIAN = span_info("My rigorous training in the martial arts has turned me into a living weapon. No limb is out of reach for my fists and feet, and my unarmed blows now have a higher chance to inflict critical blows."),
