/datum/job/roguetown/suitor
	...
	tutorial = "You are a noble from a foreign court who has travelled to Scarlet Reach in order to win the hand of Azuria's most eligible bachelor and secure a political ally for your house. Competition is fierce, and it seems you're not the only one vying for the duke's favor..."
