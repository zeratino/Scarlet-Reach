...
/mob/living/carbon/human/species/skeleton/after_creation()
	...
	ADD_TRAIT(src, TRAIT_NOFATIGUE, TRAIT_GENERIC) // NPC get infinite blue, no infinite green
	...
	if(skel_fragile)
		...
		ADD_TRAIT(src, TRAIT_NOROGSTAM, TRAIT_GENERIC) // Not touching lich balance in a fix PR - for now
