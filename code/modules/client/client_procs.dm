...
/client/proc/show_round_stats()
	...
	data += "<font color='#e6b327'><span class='bold'>Revivals:</span></font> [GLOB.azure_round_stats[STATS_REVIVALS]]<br>"
	...
	data += "<font color='#90a037'><span class='bold'>Laughs Had:</span></font> [GLOB.azure_round_stats[STATS_LAUGHS_MADE]]"
	data += "</div>"
	...
	data += "<font color='#836033'><span class='bold'>Trees Cut:</span></font> [GLOB.azure_round_stats[STATS_TREES_CUT]]<br>"
	...
	data += "<font color='#af2379'><span class='bold'>Kisses Made:</span></font> [GLOB.azure_round_stats[STATS_KISSES_MADE]]"
	data += "</div>"
...
/client/proc/show_influences()
	...
	for(var/mob/living/carbon/human/current_human in GLOB.human_list)
		...
		if(current_human.job == "Monarch")
			if(istype(current_human.patron, /datum/patron/old_god))
				psydonite_monarch = TRUE

	var/psydon_influence = (psydon_followers * 20) + (GLOB.confessors.len * 20) + (GLOB.azure_round_stats[STATS_HUMEN_DEATHS] * -20) + (GLOB.azure_round_stats[STATS_ALIVE_TIEFLINGS] * -20) + (psydonite_monarch ? (psydonite_monarch * 500) : -250) + (psycross_users * 10) + (apostasy_followers * -25) + (psydonite_user ? 10000 : -10000)
	...
	data += "Humen deaths: [GLOB.azure_round_stats[STATS_HUMEN_DEATHS]] ([get_colored_influence_value(GLOB.azure_round_stats[STATS_HUMEN_DEATHS] * -20)])<br>"
	...
	data += god_ui_block("ASTRATA", "#ffd700", "#333300", "\
		...
		Revivals: [GLOB.azure_round_stats[STATS_REVIVALS]] ([get_colored_influence_value(SSgamemode.calculate_specific_influence(astrata_storyteller, STATS_REVIVALS))])<br>\
	...
	data += god_ui_block("DENDOR", "#442200", "#ccaa88", "\
		...
		Trees cut: [GLOB.azure_round_stats[STATS_TREES_CUT]] ([get_colored_influence_value(SSgamemode.calculate_specific_influence(dendor_storyteller, STATS_TREES_CUT))])<br>\
	...
	data += god_ui_block("GRAGGAR", "#531e1e", "#ffaaaa", "\
		...
		Blood spilt: [round(GLOB.azure_round_stats[STATS_BLOOD_SPILT] / 100, 1)] ([get_colored_influence_value(SSgamemode.calculate_specific_influence(graggar_storyteller, STATS_BLOOD_SPILT))])<br>\
